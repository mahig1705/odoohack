...
const navItems: NavItem[] = [
  ...
  { label: "Discover", href: "/customer/discover", icon: <Briefcase className="w-4 h-4" /> },
  { label: "My Bookings", href: "/customer/bookings", icon: <CalendarDays className="w-4 h-4" /> },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-16">
        <div className="h-full mx-4 mt-3">
          <div className="h-full bg-background/80 backdrop-blur-xl border border-border/50 rounded-2xl shadow-sm px-4 flex items-center justify-between">
            {/* Logo */}
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48 rounded-xl">
                  <DropdownMenuItem asChild>
                    <Link to="/customer/profile" className="flex items-center gap-2 cursor-pointer">
